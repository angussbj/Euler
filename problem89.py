...
for number in numbers:
	...
	while number >= 1:
		optnumeral += 'I'
		number -= 1
	optnumerals.append(optnumeral)
print len(''.join(numerals)) - len(''.join(optnumerals))