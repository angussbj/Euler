...
class Sudoku:
	...
	def incrementSolutionCount(self):
	...
	while not puzzle.complete():
		...
		if not changes1 and not changes2:
			...
			for value in possibilities[i][j]:
				...
				if noConflicts:
					solution = duplicatePuzzle
					solved = True
					puzzle.incrementSolutionCount()
			if solved:
